...
import { FLAG_REASON_CATEGORIES, submitBusinessFlag } from "../utils/businessModeration";
import { sanitizeText } from "../utils/textSanitizer";

const isWeb = typeof window !== "undefined" && typeof document !== "undefined";

const FlagBusinessModal = ({ visible, onClose, targetUid, businessName, onSubmitted }) => {
  ...
  const nameLabel = sanitizeText(businessName) || "this business";
      ...
      <KeyboardAvoidingView behavior={Platform.OS === "ios" ? "padding" : undefined} style={styles.overlay}>
        ...
        <View style={[styles.box, darkMode && styles.boxDark]}>
          <View style={styles.header}>
            <Text style={[styles.headerTitle, darkMode && styles.headerTitleDark]}>Report business</Text>
          ...
          {submitSuccess ? (
            ...
            <ScrollView keyboardShouldPersistTaps='handled' contentContainerStyle={styles.body}>
              <Text style={[styles.subtitle, darkMode && styles.subtitleDark]}>Why are you reporting {nameLabel}?</Text>
              ...
              <TouchableOpacity style={[styles.submitButton, submitting && styles.submitButtonDisabled]} onPress={handleSubmit} disabled={submitting}>
                {submitting ? <ActivityIndicator color='#fff' size='small' /> : <Text style={styles.submitButtonText}>Submit report</Text>}
              </TouchableOpacity>
            </ScrollView>
          )}
        </View>
...
export default FlagBusinessModal;
