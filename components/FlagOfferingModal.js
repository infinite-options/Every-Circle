...
import { FLAG_REASON_CATEGORIES, submitOfferingFlag } from "../utils/offeringModeration";
import { sanitizeText } from "../utils/textSanitizer";

const isWeb = typeof window !== "undefined" && typeof document !== "undefined";

const FlagOfferingModal = ({ visible, onClose, targetUid, offeringTitle, onSubmitted }) => {
      ...
      <KeyboardAvoidingView behavior={Platform.OS === "ios" ? "padding" : undefined} style={styles.overlay}>
        ...
        <View style={[styles.box, darkMode && styles.boxDark]}>
          <View style={styles.header}>
            <Text style={[styles.headerTitle, darkMode && styles.headerTitleDark]}>Report offering</Text>
...
export default FlagOfferingModal;
