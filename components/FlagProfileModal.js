...
import { FLAG_REASON_CATEGORIES, submitProfileFlag } from "../utils/profileModeration";
import { sanitizeText } from "../utils/textSanitizer";

const isWeb = typeof window !== "undefined" && typeof document !== "undefined";

const FlagProfileModal = ({ visible, onClose, targetUid, profileName, onSubmitted }) => {
  ...
  const nameLabel = sanitizeText(profileName) || "this profile";
      ...
      <KeyboardAvoidingView behavior={Platform.OS === "ios" ? "padding" : undefined} style={styles.overlay}>
        ...
        <View style={[styles.box, darkMode && styles.boxDark]}>
          <View style={styles.header}>
            <Text style={[styles.headerTitle, darkMode && styles.headerTitleDark]}>Report profile</Text>
...
export default FlagProfileModal;
