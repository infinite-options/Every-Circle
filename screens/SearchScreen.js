...
/** Offering fields for Search cards — includes canonical shipping columns used by OfferingCardDetails. */
function expertiseDataFromSearchRow(item) {
  return {
    ...
    profile_expertise_shipping: item.profile_expertise_shipping ?? null,
    profile_expertise_shipping_amount: item.profile_expertise_shipping_amount ?? "",
    profile_expertise_shipping_cost_type: item.profile_expertise_shipping_cost_type || "",
    profile_expertise_shipping_refundable: item.profile_expertise_shipping_refundable ?? 0,
...
function mapSearchExpertiseRow(item, i) {
  return {
    ...
    expertiseData: expertiseDataFromSearchRow(item),
    profileData: {
