...
module.exports = async function (env, argv) {
  ...
  config.resolve.alias["react-native/Libraries/Components/TextInput/TextInput"] = path.resolve(__dirname, "web-stubs/TextInput.js");

  // Alias TextInputState to prevent Platform resolution
  config.resolve.alias["react-native/Libraries/Components/TextInput/TextInputState"] = path.resolve(__dirname, "web-stubs/TextInputState.js");
